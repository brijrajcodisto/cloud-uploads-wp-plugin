	...
	<div class="modal-dialog modal-dialog-centered modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="scan-modal-label"><?php esc_html_e( 'Scanning Cloud', 'cloud-uploads' ); ?></h5>
				...
				<div class="container-fluid">
					<div class="row justify-content-center mb-4 mt-3">
						<div class="col text-center">
							...
							<h4><?php esc_html_e( 'Comparing to Cloud', 'cloud-uploads' ); ?></h4>
							<p class="lead"><?php esc_html_e( "Checking for files already existing in the cloud. Please leave this tab open while we complete your scan.", 'cloud-uploads' ); ?></p>
						</div>
					</div>
