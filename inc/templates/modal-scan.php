	...
	<div class="modal-dialog modal-dialog-centered modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="scan-modal-label"><?php esc_html_e( 'Scanning Files', 's3-uploads' ); ?></h5>
				...
				<div class="container-fluid">
					...
					<div class="row justify-content-center mb-4">
						<div class="col text-center text-muted">
							<span class="h5" id="s3up-scan-progress">
								<?php
								printf(
								...
								// translators: %4$s is the closing a tag for files
									esc_html__( 'Found %1$s0 MB%2$s / %3$s0%4$s Files...', 's3-uploads' ),
									'<span id="s3-scan-storage">', '</span>', '<span id="s3-scan-files">', '</span>' );
								?>
							</span>
						</div>
					</div>
