	...
	<div class="card-body cloud p-md-5">
		<div class="row align-items-center justify-content-center mb-5">
			...
			<div class="container p-0 ml-md-3">
					...
					<?php } ?>
					<div class="row mt-2">
						<div class="col text-muted"><small><?php printf( esc_html__( 'Scanned %s ago', 'cloud-uploads' ), human_time_diff( $stats['files_finished'] ) ); ?> &dash; <a href="#" id="run-scan" class="badge badge-primary" data-toggle="modal" data-target="#scan-modal"><span
										data-toggle="tooltip"
		...
		<div class="row justify-content-center mb-5">
			<div class="col text-center">
				<form method="post" action="https://s3uploads.com/connect/?utm_source=cup_plugin&utm_medium=plugin&utm_campaign=bfu_plugin&utm_term=connect">
					<input type="hidden" name="action" value="cup_connect">
