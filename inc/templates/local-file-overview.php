<div id="local-file-overview-page" class="card">
	<div class="card-header">
		<div class="d-flex align-items-center">
			<h5 class="m-0 mr-auto p-0"><?php esc_html_e( 'Local File Overview', 's3-uploads' ); ?></h5>
	...
	<div class="card-body cloud p-md-5">
		<div class="row align-items-center justify-content-center mb-5">
			...
			<p class="lead mb-0"><?php esc_html_e( "Total Bytes / Files", 's3-uploads' ); ?></p>
			...
			<div class="container p-0 ml-md-3">
					...
					<?php } ?>
					<div class="row mt-2">
						<div class="col text-muted"><small><?php printf( esc_html__( 'Scanned %s ago', 's3-uploads' ), human_time_diff( $stats['files_finished'] ) ); ?> &dash; <a href="#" id="run-scan" class="badge badge-primary" data-toggle="modal" data-target="#scan-modal"><span
										data-toggle="tooltip"
										title="<?php esc_attr_e( 'Run a new scan to detect and sync recently uploaded files.', 's3-uploads' ); ?>"><?php esc_html_e( 'Refresh', 's3-uploads' ); ?></span></a></small>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="row justify-content-center mb-3">
			<div class="col text-center">
				<h4><?php esc_html_e( 'Ready to Connect!', 's3-uploads' ); ?></h4>
				<p class="lead"><?php esc_html_e( 'Get smart plan recommendations, create or connect to existing account, and enable video or sync to the cloud.', 's3-uploads' ); ?></p>
			</div>
		</div>
		<div class="row justify-content-center mb-5">
			<div class="col text-center">
				<form method="post" action="https://s3uploads.com/connect/?utm_source=iup_plugin&utm_medium=plugin&utm_campaign=bfu_plugin&utm_term=connect">
					...
					<button class="btn text-nowrap btn-primary btn-lg" type="submit"><span class="dashicons dashicons-cloud"></span> <?php esc_html_e( 'Connect', 's3-uploads' ); ?></button>
				</form>
			</div>
		</div>
