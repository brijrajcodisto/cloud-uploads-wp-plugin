	...
	<div class="modal-dialog modal-dialog-centered modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="upload-modal-label"><?php esc_html_e( 'Upload to Cloud', 'cloud-uploads' ); ?></h5>
			...
			<div class="modal-body">
				<div class="container-fluid">
					...
					<div class="row justify-content-center mb-4">
						<div class="col text-center">
							<div id="cup-sync-errors" class="alert alert-warning text-left" role="alert">
								<ul class="mb-0 mb-lc-0"></ul>
							</div>
							<div class="progress">
								<div id="cup-sync-progress-bar" class="progress-bar progress-bar-animated progress-bar-striped" role="progressbar" style="width: <?php echo $stats['pcnt_complete']; ?>%;" aria-valuenow="<?php echo $stats['pcnt_complete']; ?>" aria-valuemin="0"
							...
							<div class="col text-center text-muted">
								...
								<span class="h6" id="cup-upload-progress"><?php printf( __( '<span id="cup-progress-size">%s</span> / <span id="cup-progress-files">%s</span> File(s) Remaining', 'cloud-uploads' ), $stats['remaining_size'], $stats['remaining_files'] ); ?></span>
							</div>
						</div>
					</div>
					<div class="row justify-content-center mb-4">
